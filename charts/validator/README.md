...
![Version: 0.3.0](https://img.shields.io/badge/Version-0.3.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.34.2](https://img.shields.io/badge/AppVersion-0.34.2-informational?style=flat-square)
...
| ghost | object | `{"affinity":{},"arbRpcUrl":"https://arbitrum.drpc.org","chainId":"1","chainName":"eth","env":{"normal":{}},"ethArchRpcUrl":"https://mainnet.infura.io/v3/","ethConfig":{},"ethRpcUrl":"https://eth.llamarpc.com","fullnameOverride":"ghost","gnoRpcUrl":"https://gnosis-pokt.nodies.app","image":{"pullPolicy":"Always","repository":"ghcr.io/chronicleprotocol/ghost","tag":"sha-5cccda9"},"imagePullSecrets":[],"ingress":{"annotations":{},"className":"","enabled":false,"hosts":[{"host":"chart-example.local","paths":[{"path":"/","pathType":"ImplementationSpecific"}]}],"tls":[]},"libP2pSubscriptionBufferSize":"4096","libp2pValidateQueueSize":"4096","liveness":{"enabled":true,"livenessProbe":{"httpGet":{"path":"/healthcheck","port":9100},"initialDelaySeconds":30,"periodSeconds":60}},"logFormat":"text","logLevel":"info","mntRpcUrl":"https://rpc.mantle.xyz","nameOverride":"","nodeSelector":{},"optRpcUrl":"https://mainnet.optimism.io","podAnnotations":{},"podSecurityContext":{},"polRpcUrl":"https://zkevm-rpc.com","readiness":{"enabled":true,"readinessProbe":{"httpGet":{"path":"/healthcheck","port":9100},"initialDelaySeconds":30,"periodSeconds":60}},"replicaCount":1,"resources":{},"rpcUrl":"https://eth.llamarpc.com","securityContext":{},"service":{"annotations":{},"ports":{"libp2p":{"port":8000,"protocol":"TCP"},"metrics":{"port":9100,"protocol":"TCP"}},"type":"ClusterIP"},"serviceAccount":{"annotations":{},"create":true,"name":""},"tolerations":[],"watchdogConfigReg":"0x94Fea534aef6df5cF66C2DAE5CE0A05d10C068F3","watchdogInterval":"900s","webApi":{"enabled":true,"listenAddr":":8080","socks5ProxyAddr":"tor-proxy:9050"}}` | Values for Ghost |
...
| ghost.image.tag | string | `"sha-5cccda9"` | Overrides the image tag whose default is the chart appVersion. |
