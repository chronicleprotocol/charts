...
| ghost.webApi | object | `{"enabled":true,"listenAddr":"0.0.0.0:8080"}` | WEB API |
| ghost.webApi.enabled | bool | `true` | Enables the web api |
...
| global.fullnameOverride | string | `"ghost"` | Override the release name. NB only change this if you know what you are doing |
