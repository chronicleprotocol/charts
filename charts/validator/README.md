...
![Version: 0.3.25](https://img.shields.io/badge/Version-0.3.25-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.53.0](https://img.shields.io/badge/AppVersion-0.53.0-informational?style=flat-square)
...
| ghost.image.tag | string | `"0.53.0@sha256:8d9a90a902821578baf5b925653a6f8e7ede03c90d3b3fc8382e048d5a6bf201"` | Overrides the image tag whose default is the chart appVersion. |
