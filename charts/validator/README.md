...
![Version: 0.3.23](https://img.shields.io/badge/Version-0.3.23-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.46.1](https://img.shields.io/badge/AppVersion-0.46.1-informational?style=flat-square)
...
| ghost.image.tag | string | `"0.46.1@sha256:e69d8363d5a1f74d534fbae9c1d4f46909a69b9e192bb8153bb20942732911b7"` | Overrides the image tag whose default is the chart appVersion. |
...
| ghost.service | object | `{"annotations":{},"ports":{"libp2p":{"port":8000,"protocol":"TCP"},"metrics":{"port":9090,"protocol":"TCP"},"webapi":{"port":8080,"protocol":"TCP"}},"type":"LoadBalancer"}` | Service type for the validator |
...
| ghost.service.ports.metrics | object | `{"port":9090,"protocol":"TCP"}` | metrics listen port for the validator service |
