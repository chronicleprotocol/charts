...
![Version: 0.3.24](https://img.shields.io/badge/Version-0.3.24-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.47.4](https://img.shields.io/badge/AppVersion-0.47.4-informational?style=flat-square)
...
| ghost.image.tag | string | `"0.47.4@sha256:b539ec2d7db53db8d19f87a7a527728d02dd398088dae5785996ee019112e390"` | Overrides the image tag whose default is the chart appVersion. |
