...
| erpc.server.httpHostV4 | string | `"0.0.0.0"` |  |
| erpc.server.httpHostV6 | string | `"[::]"` |  |
| erpc.server.httpPort | int | `4000` |  |
| erpc.server.listenV4 | bool | `true` |  |
| erpc.server.listenV6 | bool | `false` |  |
| erpc.server.maxTimeout | string | `"30s"` |  |
| erpc.server.readTimeout | string | `"10s"` |  |
| erpc.server.writeTimeout | string | `"20s"` |  |
| extraObjects | list | `[]` |  |
