...
![Version: 0.7.1](https://img.shields.io/badge/Version-0.7.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.1.1](https://img.shields.io/badge/AppVersion-0.1.1-informational?style=flat-square)
...
| deploymentAnnotations | object | `{}` | Annotations for the Deployment itself. Stakater Reloader reads workload metadata, so reloader annotations belong here, not podAnnotations. |
...
| image.tag | string | `"0.1.1@sha256:8bfed3d49a086f3bcf7be34ad69fd3f9abda6e53aa600e3d82e435a29a111137"` |  |
