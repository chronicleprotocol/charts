...
A Helm chart for deploying rpc-splitter Kubernetes
...
| ethRpc | string | `"https://mainnet.infura.io/v3/"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"ghcr.io/chronicleprotocol/rpc-splitter"` |  |
| image.tag | string | `""` |  |
